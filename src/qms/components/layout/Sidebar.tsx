...
import type { ActiveSection, Permission } from '@/qms/types/qms';
import { CORE_MODULES, INDUSTRY_CONFIG, isIndustryType } from '@/qms/types/qms';
import {
  LayoutDashboard,
  FileText,
  GitBranch,
...
import { ScrollArea } from '@/qms/components/ui/scroll-area';

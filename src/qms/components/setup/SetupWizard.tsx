...
import type { IndustryType, OrgSettings } from '@/qms/types/qms';
import { CORE_MODULES, OPTIONAL_MODULES, STANDARDS_BY_INDUSTRY } from '@/qms/types/qms';
import { useTranslation } from '@/qms/lib/i18n';
